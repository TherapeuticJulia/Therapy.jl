...
# Inspired by warm, scholarly aesthetics

"""
Main documentation layout with navigation and footer.
Uses parchment color scheme with dark mode support.
"""
                ...
                Div(:class => "flex justify-between h-16",
                    ...
                    Div(:class => "flex items-center",
                        A(:href => "./", :class => "flex items-center",
                            Span(:class => "text-2xl font-bold text-emerald-700 dark:text-emerald-400", "Therapy"),
            ...
            Div(:class => "max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8",
                Div(:class => "text-center",
                    P(:class => "text-neutral-500 dark:text-neutral-400 text-sm",
                        "Built with ",
                        A(:href => "./", :class => "text-emerald-700 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300", "Therapy.jl"),
